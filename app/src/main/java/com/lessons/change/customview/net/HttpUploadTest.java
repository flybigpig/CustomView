package com.lessons.change.customview.net;
...
import static com.lessons.change.customview.net.HttpUploadTest.uploadedKByte;
...
public class HttpUploadTest extends Thread {
    ...
    public void run() {
        try {
            ...
            Log.d("uploadssss_rate", String.valueOf(finalUploadRate));
            Log.d("speed_test4 upload_", String.valueOf(finalUploadRate));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                Log.d("uploadssss_size", String.valueOf(uploadedKByte));
