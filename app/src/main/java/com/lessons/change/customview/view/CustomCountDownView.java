...
public class CustomCountDownView extends View {
    ...
    private int mRingProgessTextSize = 15;
    ...
    public CustomCountDownView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }
    ...
    public CustomCountDownView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.gray));

        mRingWidth = a.getFloat(R.styleable.CountDownView_ringWidth, 15);

        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, 50);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mRectF = new RectF(0 + getPaddingLeft() + mRingWidth / 2, 0 + getPaddingTop() + mRingWidth / 2,
                mWidth - getPaddingRight() - mRingWidth / 2, mHeight - getPaddingBottom() - mRingWidth / 2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /**
         *  360 - mCurrentProgress  逆时针
         *  mCurrentProgress - 360 顺时针
         */
